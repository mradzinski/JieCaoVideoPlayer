...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myJZVideoPlayerStandard.setUp(
                ...
                JZVideoPlayerStandard.SCREEN_LAYOUT_NORMAL, "Just a test");

        myJZVideoPlayerStandard.thumbImageView
                .setImageURI("http://jzvd-pic.nathen.cn/jzvd-pic/1bb2ebbe-140d-4e2e-abd2-9e7e564f71ac.png");
